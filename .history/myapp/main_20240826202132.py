...
# Eyes
open_eye_image = ImageTk.PhotoImage(Image.open(r"assets/open_eye.png").resize((20, 20), Image.Resampling.LANCZOS))
closed_eye_image = ImageTk.PhotoImage(Image.open(r"assets/closed-eyes.png").resize((20, 20), Image.Resampling.LANCZOS))
...
image = Image.open(r"/myapp/assets/logo.jpglogo.jpg")
