...
def show_help():
    ...
    *********************************************************************************************************
    Chào mừng bạn đến với Ứng dụng Mã hóa Thuật toán!
...
Nhập văn bản bạn muốn mã hóa hoặc giải mã.
Nhập khóa nếu thuật toán được chọn yêu cầu một khóa.
Chọn thuật toán từ danh sách thả xuống.
Nhấp vào 'Mã hóa' hoặc 'Giải mã' tùy theo nhu cầu của bạn.
Sử dụng nút 'Sao chép' để sao chép kết quả hoặc 'Lưu' để lưu vào tệp.
Mẹo:
