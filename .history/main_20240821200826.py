...
tk.Button(frame_actions, text="Encrypt", command=on_encrypt).grid(row=0, column=1)
tk.Button(frame_actions, text="Decrypt", command=on_decrypt).grid(row=0, column=1)
