...
strength_bar.grid(row=3, column=1, padx=5, pady=5)

random_password_button = ttk.Button(frame_input, text="Randomize Passwood", command=lambda: randomize_password(entry_text))
random_password_button.grid(row=4, column=1, padx=5, pady=5)
