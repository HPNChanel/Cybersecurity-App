...
def update_language(language):
    ...
    font_scale.config(text=get_text("font_size"))
...
# Font scale widget
font_scale = tk.Scale(app, from_=8, to=32, orient=tk.HORIZONTAL, label="Font Size", command=lambda size: result_display.config(font=("Helvetica", int(size))))
font_scale.set(12)
