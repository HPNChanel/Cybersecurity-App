...
entry_text = Text(frame_input, width=50, height=4, wrap="word")
...
entry_key = Text(frame_input, width=50, height=2, wrap="word")
...
entry_password.bind("<KeyRelease>", command=check_password_strength)
...
# Eyes
open_eye_image = ImageTk.PhotoImage(Image.open(r"D:\FOR_WORK\PERSONAL_PROJECT\Python_Project_For_Career\Cybersecurity_App\open_eye.png").resize((20, 20), Image.Resampling.LANCZOS))
closed_eye_image = ImageTk.PhotoImage(Image.open(r"D:\FOR_WORK\PERSONAL_PROJECT\Python_Project_For_Career\Cybersecurity_App\closed-eyes.png").resize((20, 20), Image.Resampling.LANCZOS))
