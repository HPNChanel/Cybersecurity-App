...
def toggle_theme():
    ...
    if current_bg == "#EDF7F6":
        ...
        entry_text.config(bg="##454545", fg="#EDEDED", insertbackground)
...
random_password_button = ttk.Button(frame_input, text="Randomize Password",command=randomize_password)
