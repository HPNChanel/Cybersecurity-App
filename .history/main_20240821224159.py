...
def copy_to_clipboard():
    ...
    messagebox.showinfo("Copy Success", "The result has been ")
...
def toggle_theme():
    ...
    if current_bg == "white":
        app.config(bg="black")
        frame_input.config(bg="black")
        frame_algo.config(bg="black")
        frame_actions.config(bg="black")
        frame_result.config(bg="black")
...
lightbulb_icon = PhotoImage(file='D:\FOR_WORK\PERSONAL_PROJECT\Python_Project_For_Career\Cybersecurity_App\light-bulb.png')
